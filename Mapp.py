...
def main() -> None:
    ...
    with st.sidebar:
        ...
        selected_main_page = st.radio("Go to", main_pages, index=main_index, key="sidebar_main_nav")
        page = current_page if current_page in page_dispatch else main_pages[0]
