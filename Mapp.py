    ...
    if materials_section == "Add Vendor Info":
        ...
        if mats.empty:
            ...
            if vendor_edit_all_df.empty:
                st.info("No vendor records found.")
            else:
                vendor_options_edit = {
                    f"{row['material_name']} | {row['vendor_name']} | {normalize_vendor_item_number(row.get('vendor_item_number')) or 'No Item #'} | Vendor ID {int(row['material_vendor_id'])}": int(row['material_vendor_id'])
                    for _, row in vendor_edit_all_df.iterrows()
                }
                selected_vendor_label = st.selectbox(
                    "Select vendor record to edit",
                    list(vendor_options_edit.keys()),
                    key="add_vendor_info_edit_select",
                )
                ...
                edit_material_search = st.text_input(
                    ...
                    value="",
                    key="edit_vendor_material_search",
                )
                ...
                edit_material_label = st.selectbox(
                    ...
                    key="add_vendor_info_edit_material",
                )
                ...
                with st.form("add_vendor_info_edit_form"):
                    ...
                    edit_latest_retail_price = v6.number_input(
                        ...
                        key="add_vendor_info_edit_retail_price",
                    )
                    ...
                    edit_latest_retail_price_date = v7.date_input(
                        ...
                        format="MM/DD/YYYY",
                        key="add_vendor_info_edit_retail_date",
                    )
                    v8, v9 = st.columns(2)
                    edit_latest_quoted_price = v8.number_input(
                        ...
                        key="add_vendor_info_edit_quoted_price",
                    )
