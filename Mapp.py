...
def page_projects(project_section: str | None = None) -> None:
    ...
    if project_section == "Create Project":
        ...
        if projects_df.empty:
            ...
            project_options = {f"{row['project_name']} | ID {int(row['project_id'])}": int(row['project_id']) for _, row in projects_df.iterrows()}
            selected_project_label = st.selectbox("Select project to edit", list(project_options.keys()), key="edit_project_select")
    ...
    if project_section == "Add Sub-Project":
        ...
        if projects.empty:
            ...
            if subprojects_df.empty:
                ...
                selected_subproject_label = st.selectbox("Select sub-project to edit", list(subproject_options.keys()), key="edit_subproject_select")
