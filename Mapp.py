...
def build_project_report_pdf(project_id: int, orientation: str = "Landscape") -> BytesIO:
    ...
    if project_section == "Project Detail / Reports":
        ...
        if not all_lines.empty:
            ...
            if col_pdf1.button("Prepare Project PDF", key=f"prep_project_pdf_{project_id}"):
                st.session_state[project_pdf_key] = build_project_report_pdf(project_id, orientation_choice).getvalue()
